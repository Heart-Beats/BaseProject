...
import com.hl.bitmaputil.ScanFileActionUtil
import com.hl.dateutil.getFormattedNowDateTime
import com.hl.download.DownloadFileUtil
import com.hl.json.GsonUtil
import com.hl.permission.reqPermissions
import com.hl.popup.showImages
import com.hl.previewfile.PreviewFileActivity
import com.hl.smsutil.SmsHelper
import com.hl.ui.base.FragmentContainerActivity
...
import com.hl.web.H5Constants
import com.hl.web.WebViewFragment
import com.hl.web.WebViewFragmentArgs
import com.hl.web.bean.AndroidDeviceInfo
import com.hl.web.bean.DownLoadFileParam
import com.hl.web.bean.GetNetworkConnectTypeReturn
import com.hl.web.bean.H5CallParam
import com.hl.web.bean.H5DeviceInfo
import com.hl.web.bean.H5GetDataEntity
import com.hl.web.bean.H5GetDataReturn
import com.hl.web.bean.H5NavigateBackParam
import com.hl.web.bean.H5NavigateToParam
import com.hl.web.bean.H5Return
import com.hl.web.bean.H5SaveDataEntity
import com.hl.web.bean.H5SetWebViewParam
import com.hl.web.bean.PreviewFileParam
import com.hl.web.bean.PreviewImageParam
import com.hl.web.bean.SavePhotoToAlbumParam
import com.hl.web.bean.ScanQRCodeReturn
import com.hl.web.bean.Share2PlatformParam
import com.hl.web.bean.StatusBarColorParam
import com.hl.web.bean.StatusBarLightModeParam
import com.hl.web.helpers.H5DataHelper
import com.hl.web.helpers.logJs
import com.hl.web.helpers.onFail
import com.hl.web.helpers.onSuccess
import com.hl.web.receiver.CallBackFunctionDataStore
import com.hl.web.receiver.CallBackFunctionHandlerReceiver
import com.hl.web.utils.ClipboardHelper
import com.hl.web.utils.getCurrentNavigationFragment
...
class IStandSdkImpl(private val webViewFragment: Fragment, val bridgeWebView: BridgeWebView) :
	...
	override fun getDeviceInfo(handlerName: String) {
		commonRegisterHandler(handlerName) { _, function ->
			...
			webViewFragment.statusBarHeight

			// h5 获取的状态栏高度需要除以 density
			val statusBarHeightDp =
				webViewFragment.statusBarHeight / bridgeWebView.resources.displayMetrics.density
